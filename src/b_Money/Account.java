...
public class Account {
	...
	public void addTimedPayment(String id, Integer interval, Integer next, Money amount, Bank tobank, String toaccount) {
		...
		if(!timedpayments.containsKey(id)) timedpayments.put(id, tp); 
		//if statement can be added to check if timed payment which we want to add, doesn't already exists
	}
	...
	public void removeTimedPayment(String id) {
		if(timedpayments.containsKey(id)) timedpayments.remove(id);
		//if statement can be added to check if timed payment which we want to remove exists
	}
